...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "subtitle svelte-292k79");
    			set_style(p, "font-size", /*width*/ ctx[2] / 20 + "px");
    			set_style(p, "padding-top", /*width*/ ctx[2] / 100 + "px");
    			add_location(p, file$1, 50, 4, 20955);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path4, file$1, 38, 4, 853);
    			attr_dev(path5, "class", "text svelte-292k79");
    			...
    			add_location(path5, file$1, 43, 4, 10888);
    			attr_dev(svg, "width", /*width*/ ctx[2]);
    			attr_dev(svg, "height", svg_height_value = /*width*/ ctx[2] * 598 / 2305);
    			attr_dev(svg, "viewBox", "0 0 2305 598");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$1, 6, 2, 202);
    			add_render_callback(() => /*main_elementresize_handler*/ ctx[3].call(main));
    		...
    		m: function mount(target, anchor) {
    			...
    			main_resize_listener = add_resize_listener(main, /*main_elementresize_handler*/ ctx[3].bind(main));
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*width*/ 4) {
    				attr_dev(svg, "width", /*width*/ ctx[2]);
    			...
    			if (dirty & /*width*/ 4 && svg_height_value !== (svg_height_value = /*width*/ ctx[2] * 598 / 2305)) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ subtitle, clientWidth, width });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*clientWidth*/ 2) {
    			$$invalidate(2, width = Math.min(Math.max(screen.width, screen.height) * 0.5, Math.max(clientWidth, 300)));
    		}
    	};

    	$$invalidate(1, clientWidth = 0);
    	return [subtitle, clientWidth, width, main_elementresize_handler];
    }

    class Logo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { subtitle: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	logo = new Logo({
    			props: { subtitle: "work in progress" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-dfx0qj");
    			add_location(main, file, 3, 0, 74);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
